...
class Business:
    def __init__(self):
        self.credits = 0
        self.stone = {'value': 1, 'miner_cost': 10, 'miner_cost_multiplier': 2, 'amount': 0, 'miners': 0}
        self.copper = {'value': 5, 'miner_cost': 64, 'miner_cost_multiplier': 4, 'amount': 0, 'miners': 0}
    ...
    def buy_miner(self, material):
        if self.credits >= material['miner_cost']:
            ...
            material['miner_cost'] *= material['miner_cost_multiplier']
            material['miners'] += 1
...
def main():
    ...
    BUTTON_BUY_MINER_COPPER = pygame.Rect(240, 112, 32, 32)
    BUTTON_SELL_STONE = pygame.Rect(8, 64, 32, 32)
    BUTTON_SELL_COPPER = pygame.Rect(8, 112, 32, 32)
    ...
    while run:
        ...
        if event_timer_1000:
            ...
            b.copper['amount'] += b.copper['miners']
        ...
        if event_mousebuttondown and pygame.mouse.get_pressed()[0]:
            ...
            if BUTTON_BUY_MINER_STONE.collidepoint(mouse_pos):
                b.buy_miner(b.stone)
            if BUTTON_BUY_MINER_COPPER.collidepoint(mouse_pos):
                b.buy_miner(b.copper)
            if BUTTON_SELL_STONE.collidepoint(mouse_pos):
                b.sell(b.stone)
            if BUTTON_SELL_COPPER.collidepoint(mouse_pos):
                b.sell(b.copper)
